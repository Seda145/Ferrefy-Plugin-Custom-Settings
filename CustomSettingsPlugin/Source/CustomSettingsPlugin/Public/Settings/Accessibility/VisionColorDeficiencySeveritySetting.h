...
#include "VisionColorDeficiencySeveritySetting.generated.h"


UCLASS()
class CUSTOMSETTINGSPLUGIN_API UVisionColorDeficiencySeveritySetting : public UCustomSliderSetting {
    GENERATED_BODY()
