...
#include "GamepadXAxisRotateSensitivitySetting.generated.h"


UCLASS()
class CUSTOMSETTINGSPLUGIN_API UGamepadXAxisRotateSensitivitySetting : public UCustomSliderSetting {
    GENERATED_BODY()
