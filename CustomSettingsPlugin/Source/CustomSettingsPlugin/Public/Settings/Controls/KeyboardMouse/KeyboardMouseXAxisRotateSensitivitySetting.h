...
#include "KeyboardMouseXAxisRotateSensitivitySetting.generated.h"


UCLASS()
class CUSTOMSETTINGSPLUGIN_API UKeyboardMouseXAxisRotateSensitivitySetting : public UCustomSliderSetting {
    GENERATED_BODY()
