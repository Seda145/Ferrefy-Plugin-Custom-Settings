...
#include "KeyboardMouseYAxisRotateSensitivitySetting.generated.h"


UCLASS()
class CUSTOMSETTINGSPLUGIN_API UKeyboardMouseYAxisRotateSensitivitySetting : public UCustomSliderSetting {
    GENERATED_BODY()
